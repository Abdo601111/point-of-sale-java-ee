...
/**
 * @(#)IceKey.java         05/May/2008
 * Copyright 2008 iTSoft , Inc. All rights reserved.
 */
/**
 * This class implements the ICE Key encryption algorithm for Encrypt and
 * Decrypt. The originall algorithm was created by Matthew Kwan - December 1996,
 * and it was working for 8-chars only. The modification for length made by
 * Mohamed Ezzat, and the idea based on the following:
 *
 * <DL>
 * <DT><STRONG>First:</STRONG>
 * <DD>If the length of the password is less than 8-chars; then we will add the
 * empty char "0 in byte code" to the end of the password until we obtain 8-char
 * password.
 * <DT><STRONG>Second:</STRONG>
 * <DD>If the length is more than 8-char; we will divide the password to blocks
 * of 8-chars and Encode every one of the blocks separately. <br>
 * In case if the last block is less than 8-char; we will use the same mechanism
 * in first point. <br>
 * At The End we got a String of Encoded Concatenated Blocks; Each Block of
 * length (16*n)-chars.
 * </DL>
 * 
 * @since 04/May/2008
 * @author Mohamed Ezzat Mohamed
 * @reviewer
 */
public class IceKey {
	private int size;
	 ...
	 * 
	 * @param encr
	 *            Array of 8-bytes to be converted to 16-bytes.
	 ...
	 * 
	 * @param hexPass
	 *            Hexdecimal String to be converted to Array of 8-byte .
	 ...
	 * 
	 * @param: The
	 *             Decoded String Saved in DB in Hexdecimal formate.
